...
{
#pragma region 시간복잡도
	//컴퓨터 프로그램의 입력값과 연산 수행 시간의 상관 관계를 나타내는 척도입니다
...
#pragma region 0(log n) 로그시간
	//테이터 크기에 따라 실행 시간이 로그 함수의 형태로 증가하는 시간 복잡도 입니다

	//ex)이진탐색
#pragma endregion

#pragma region 0(n)선형 시간
	//입력에 따라 걸리는 시간이 순차적으로 뭐시기 시간복잡도
...
#pragma region 공간복잡도
	//프로그램 실행과 완료에 얼마나 많은 공간이 필요하니 지 나타내는 척도입니다
...
#pragma region 점근적 표기법
	//상수 계수와 중요하지 않은 항목을 제거하여 표기하는 표기법 입니다.
